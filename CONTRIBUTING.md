# Contributing to @plasius/player-system-interface
...
`@plasius/player-system-interface` provides world-space Player System overlays, focus panes, and target-surface contracts for Plasius game experiences.

Contributions typically fall into overlay contracts, pane metadata, target-anchor helpers, docs, tests, and tooling quality.
