...
## Scope
- This repository contains `@plasius/player-system-interface`.
- The package provides world-space Player System overlays, focus panes, and target-surface contracts for Plasius game experiences.
